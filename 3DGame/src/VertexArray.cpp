...
VertexArray::VertexArray(const void* verts, unsigned int numVerts,
	EVertexLayout layout, const unsigned int* indices,
...
unsigned int VertexArray::GetVertexSize(VertexArray::EVertexLayout layout) {
	unsigned vertexSize = 8 * sizeof(float);
	if (layout == EVertexLayout::PosNormSkinTex) {
