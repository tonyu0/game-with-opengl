...
LevelLoader::sComponentFactoryMap{
	{"AudioComponent",
	 {(int)Component::EComponentType::TAudioComponent, &Component::Create<AudioComponent>}},
	{"BallMove", {(int)Component::EComponentType::TBallMove, &Component::Create<BallMove>}},
	{"BoxComponent",
	 {(int)Component::EComponentType::TBoxComponent, &Component::Create<BoxComponent>}},
	{"CameraComponent",
	 {(int)Component::EComponentType::TCameraComponent, &Component::Create<CameraComponent>}},
	{"FollowCamera",
	 {(int)Component::EComponentType::TFollowCamera, &Component::Create<FollowCamera>}},
	{"MeshComponent",
	 {(int)Component::EComponentType::TMeshComponent, &Component::Create<MeshComponent>}},
	{"MoveComponent",
	 {(int)Component::EComponentType::TMoveComponent, &Component::Create<MoveComponent>}},
	{"SkeletalMeshComponent",
	 {(int)Component::EComponentType::TSkeletalMeshComponent,
	  &Component::Create<SkeletalMeshComponent>}},
	{"SpriteComponent",
	 {(int)Component::EComponentType::TSpriteComponent, &Component::Create<SpriteComponent>}},
	{"MirrorCamera",
	 {(int)Component::EComponentType::TMirrorCamera, &Component::Create<MirrorCamera>}},
	{"PointLightComponent",
	 {(int)Component::EComponentType::TPointLightComponent,
	  &Component::Create<PointLightComponent>}},
	{"TargetComponent",
	 {(int)Component::EComponentType::TTargetComponent, &Component::Create<TargetComponent>}},
};
		...
		if (compObj.IsObject()) {
			...
			if (JsonHelper::GetString(compObj, "type", type)) {
				...
				if (iter != sComponentFactoryMap.end()) {
					...
					Component::EComponentType tid =
						static_cast<Component::EComponentType>(iter->second.first);
...
void LevelLoader::SaveGlobalProperties(
	rapidjson::Document::AllocatorType& alloc, Game* game,
...
void LevelLoader::SaveActors(rapidjson::Document::AllocatorType& alloc,
	...
	for (const Actor* actor : actors) {
		...
		JsonHelper::AddString(alloc, obj, "type",
			Actor::TypeNames[(int)actor->GetType()]);
...
void LevelLoader::SaveComponents(rapidjson::Document::AllocatorType& alloc,
	...
	for (const Component* comp : components) {
		...
		// Add type
		JsonHelper::AddString(alloc, obj, "type",
			Component::TypeNames[(int)comp->GetType()]);
